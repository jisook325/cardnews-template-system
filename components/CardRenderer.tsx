...
export const themes: Record<string, ColorTheme> = {
  ...
  pistachio: {
    ...
    secondaryTextColor: '#386A3B',
    metaTextColor: '#558758',
  ...
  periwinkle: {
    ...
    secondaryTextColor: '#3B5B9E',
    metaTextColor: '#5C7CBA',
    borderThemeColor: '#1E3A8A',
  },
  lemon: {
    bgColor: '#FCFF82',
    boxBgColor: '#FFFFFF',
    primaryTextColor: '#9C4221',
    secondaryTextColor: '#C05621',
    metaTextColor: '#DD6B20',
    borderThemeColor: '#9C4221',
  },
  cantaloupe: {
    bgColor: '#FF9C6D',
    boxBgColor: '#FFFFFF',
